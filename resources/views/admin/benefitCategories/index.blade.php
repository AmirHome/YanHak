...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.benefitCategory.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-BenefitCategory">
            <thead>
                <tr>
                    <th width="10">
...
@can('benefit_category_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.benefit-categories.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.benefit-categories.index') }}",
    columns: [
