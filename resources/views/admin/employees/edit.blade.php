    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.employees.update", [$employee->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identity') ? 'is-invalid' : '' }}" type="number" name="identity" id="identity" value="{{ old('identity', $employee->identity) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}" type="text" name="mobile" id="mobile" value="{{ old('mobile', $employee->mobile) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('family') ? 'is-invalid' : '' }}" type="text" name="family" id="family" value="{{ old('family', $employee->family) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('benefits') ? 'is-invalid' : '' }}" name="benefits[]" id="benefits" multiple required>
                    @foreach($benefits as $id => $benefit)
                        <option value="{{ $id }}" {{ (in_array($id, old('benefits', [])) || $employee->benefits->contains($id)) ? 'selected' : '' }}>{{ $benefit }}</option>
                    @endforeach
                </select>
